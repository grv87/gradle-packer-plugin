 ...
 * file provisioner/windows-shell/provisioner.go
...
@CompileStatic
class WindowsShell extends Provisioner<Config> {
  @AutoImplement
  ...
  static void register(AbstractEngine engine) {
    engine.registerSubtype Provisioner, 'windows-shell', this
  }
}
