...
interface InterpolableString extends InterpolableValue<SimpleInterpolableString, String, InterpolableString> {
  ...
  @InheritConstructors
  final class Initialized extends InterpolableValue.Initialized<SimpleInterpolableString, String, InterpolableString, AlreadyInterpolated, Initialized> implements InterpolableString { }
